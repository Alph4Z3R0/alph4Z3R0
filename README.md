...
<sub>These cards are static SVGs generated by GitHub Actions and committed to this repo — see the workflow file below — instead of the public live endpoints, so they never break from rate limits or downtime.</sub>
